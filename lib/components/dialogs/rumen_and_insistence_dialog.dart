...
class RumenAndInsistenceDialog extends StatefulWidget {
  @override
  _RumenAndInsistenceDialogState createState() =>
      _RumenAndInsistenceDialogState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return AlertDialog(
        ...
        content: productState.rumenAndInsistenceList.length > 8
            ? Column(
                ...
                children: <Widget>[
                  ...
                  Expanded(child: Consumer<ProductState>(
                          ...
                          return Column(
                            children: <Widget>[
                              GestureDetector(
                                onTap: () {
                                  productState
                                      .updateChangesOnRumenAndInsistenceList(
                                          index);
                                ...
                                child: Container(
                                  ...
                                  height: 40,
                                  child: Text(
                                    productState.rumenAndInsistenceList[index]
                                        .optionsName,
                                    style: TextStyle(
                                        color: cBlack,
                                        fontSize: 14,
            ...
            : SingleChildScrollView(
                ...
                children: <Widget>[
                  ...
                  LimitedBox(
                    maxHeight:
                        productState.rumenAndInsistenceList.length * 60.0,
                    child: Column(
                      ...
                      children: <Widget>[
                        Consumer<ProductState>(
                          ...
                          return ListView.builder(
                              shrinkWrap: true,
                              itemCount:
                                  productState.rumenAndInsistenceList.length,
                              itemBuilder: (context, index) {
                                return Column(
                                  children: <Widget>[
                                    GestureDetector(
                                    ...
                                    index !=
                                            productState.rumenAndInsistenceList
                                                    .length -
                                                1
                                        ? Divider()
                                        : Container()
