  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return AlertDialog(
        ...
        content: productState.encapsulationList.length > 8
            ? Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    height: 40,
                    child: Text(
                      AppLocalizations.of(context).encupsulation,
                      style: TextStyle(
                          color: cBlack,
                          fontSize: 16,
                            ...
                            return Column(
                              children: <Widget>[
                                GestureDetector(
                                  onTap: () {
                                    productState
                                        .updateChangesOnEncapsulationList(
                                            index);
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      productState
                                          .encapsulationList[index].optionsName,
                                      style: TextStyle(
                                          color: cBlack,
                                          fontSize: 14,
                                ...
                                index !=
                                        productState.encapsulationList.length -
                                            1
                                    ? Divider()
                                    : Container()
                              ],
                                  ...
                                  children: <Widget>[
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        height: 40,
                                        child: Text(
                                          productState.encapsulationList[index]
                                              .optionsName,
                                          style: TextStyle(
                                              color: cBlack,
                                              fontSize: 14,
