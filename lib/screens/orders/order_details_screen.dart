...
import 'package:ninan/components/option_title/option_title.dart';
            ...
            child: Row(
              children: <Widget>[
                ...
                Container(
                    ...
                    child: Text(
                      carttDetail.carttAmount.toString(),
                      style: TextStyle(
                          color: cPrimaryColor,
                          fontSize: 16,
                          fontWeight: FontWeight.w700),
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: cWhite,
                      border:
                          Border.all(color: Color(0xff203B8A26), width: 1.0),
                    ),
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        _buildRow(AppLocalizations.of(context).orderPrice,
