...
import 'package:ninan/models/cart_details.dart';
import 'package:ninan/models/cart.dart';
import 'package:ninan/screens/cart/components/add_cupon.dart';
import 'package:ninan/screens/cart/components/add_note.dart';
import 'package:ninan/screens/home/components/select_location.dart';
...
import 'package:ninan/screens/cart/components/select_pay.dart';
...
import 'package:ninan/models/cart_item.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<List<CartDetails>> _getCartDetails() async {
    ...
    if (results['response'] == '1') {
      ...
      cartDetails =
          iterable.map((model) => CartDetails.fromJson(model)).toList();
      setState(() {
                    ...
                    trailing: GestureDetector(
                      ...
                      child: Container(
                        padding: EdgeInsets.only(
                            right: 15, left: 15, top: 6, bottom: 6),
                        decoration: BoxDecoration(
                    ...
                    child: CustomButton(
                        ...
                        onPressedFunction: () async {
                          if (_appState.payMethod != null) {
                            ...
                            showErrorDialog(
                                "يجب  اختيار طريقة الدفع اولا", context);
                          }
                        }))
              ],
            )));
