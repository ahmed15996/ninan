...
import 'package:ninan/components/horizontal_divider/horizontal_divider.dart';
                    ...
                    if (_appState.acceptTerms) {
                      ...
                      if (results['response'] == '1') {
                        ...
                        _appState.setCurrentUser(
                            User(userId: results['user_id'].toString()));
                        Navigator.pushNamed(
                            context, '/register_code_activation_screen');
                      } else
    http://api.yamamah.com/SendSMSV2?Username=0554564194&Password=Abdullah@2020&Tagname=NINAN&RecepientNumber=0591000110;0547668576&Message=code&SendDateTime=0&EnableDR=true&SentMessageID=True{
                        showErrorDialog(results['message'], context);
                      }
                    } else {
                      showErrorDialog(
                          AppLocalizations.of(context).acceptTerms, context);
                    }
                  },
              ),
            ),
