...
import 'package:ninan/components/app_repo/auth_state.dart';
...
class _PasswordActivationCodeScreenState
    extends State<PasswordActivationCodeScreen> {
  ...
  Widget build(BuildContext context) {
    final appBar = AppBar(
        ...
        leading: IconButton(
          icon: Consumer<AppState>(builder: (context, appState, child) {
